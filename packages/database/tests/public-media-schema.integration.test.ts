...
describe("public media persistence", () => {
  ...
  test("keeps the Increment 3 Drizzle snapshot chain linked through migration 0023", async () => {
    ...
    const snapshot23 = JSON.parse(await readFile(new URL("../migrations/meta/0023_snapshot.json", import.meta.url), "utf8")) as { prevId: string };
  ...
  test("applies the complete current migration journal through id/count 26", async () => {
